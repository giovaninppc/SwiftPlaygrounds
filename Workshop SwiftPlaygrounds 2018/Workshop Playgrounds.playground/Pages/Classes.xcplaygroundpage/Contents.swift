...
class Carro{
    var limiteConbustivel: Double
    var consumo: Double
    
    init(con: Double){
        limiteConbustivel = 40
        consumo = con
    }
    
    func andar(){
        limiteConbustivel -= consumo
    }
}

var Ka = Carro(con: 2)
var belina = Carro(con: 10)
belina.andar()
belina.limiteConbustivel

Ka.andar()
Ka.limiteConbustivel
